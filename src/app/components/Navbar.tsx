    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* ── Mobile logo: big enough to read, small enough to leave room for hamburger ── */
        @media (max-width: 860px) {
          .nav-inner   { height: 64px; padding: 0 16px; }
          .nav-logo-img { width: 130px; height: 52px; }
        }
        @media (max-width: 480px) {
          .nav-logo-img { width: 110px; height: 44px; }
        }
        @media (max-width: 360px) {
          .nav-logo-img { width: 90px; height: 36px; }
        }
        ...
        @media (max-width: 860px) { .nav-ham { display: flex !important; } }
        ...
        /* ── Mobile menu top bar — logo matches navbar size ── */
        .mob-top {
        ...
        @media (max-width: 480px) {
          .mob-logo-img { width: 110px; height: 44px; }
        }
