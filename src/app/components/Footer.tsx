  ...
  return (
    <>
      <style>{`
        ...
        .logo-name span { background: linear-gradient(135deg,#00d2b4,#7050ff); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; }
        ...
        .col-text { font-size: 14px; color: rgba(255,255,255,0.38); }
          ...
          <div>
            ...
            <div className="contact-item">
              ...
              <div className="contact-info">
                ...
                <span className="contact-val">India (Remote Worldwide)</span>
              </div>
            </div>
