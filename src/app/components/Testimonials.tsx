...
const TESTIMONIALS = [
  {
    ...
    text: "ClipCraft completely transformed our online presence. Within 3 weeks our leads doubled. Best investment we made this year.",
    avatar: "AS",
    accent: "#00d2b4",
  ...
  },
  {
    ...
    text: "Our Google Ads campaign brought in 200+ new customers in the first month. ClipCraft knows exactly how to target the right audience.",
    avatar: "KM",
    accent: "#ff5096",
