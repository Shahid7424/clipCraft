...
const CONTACT_ITEMS = [
  { icon: "@",  label: "Email",    val: "wajahatnaveed999@gmail.com",     href: "mailto:wajahatnaveed999@gmail.com" },
  { icon: "✆",  label: "Phone",    val: "+91 9822449515",        href: "tel:+91 9822449515" },
  { icon: "◉",  label: "Location", val: "Near momin clinic, gulam Ali nagar , Mohammad wadi road Hadapsar Pune 411028", href: null },
];
